...
$("input").trigger(e);
                        ...
                        function ok() {
                            if(getOs()==="tel"){
                            document.getElementById("bts").innerHTML='<input type="button" onclick="fh()" value="↑"/><input type="button" onclick="fb()" value="↓"/><input type="button" onclick="fg()" value="←"/><input type="button" onclick="fd()" value="→"/>';
                        };p6001200();
}
var p6001200=function(){
    var lg,vts;
if(getOs()==="tel"){lg=400;vts=200}else{lg=600;vts=100};
    var corps=document.getElementById("corps");
    corps.innerHTML='<audio src="snake.opus" id="audio" type="audio/opus"autoplay loop=true></audio><p>Snake by Nick Morgan</p><canvas id="canvas" width="'+lg+'" height="'+lg+'"></canvas>';
    ...
    Serpent.prototype.deplacer = function () {
        ...
        if (this.verifierCollision(nouvelleTete)) {
            document.getElementById("audio").src="gameover.opus";
            document.getElementById("audio").loop=false;
            document.getElementById("btgo").innerHTML='<input type="button" value="Recommencer" onclick="window.location.href=\'../../../../rd/snk/\'";/>';
            gameOver();
            return;
        }
